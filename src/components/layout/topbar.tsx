...
export async function Topbar({ title, backHref }: TopbarProps) {
      ...
      <div className="flex items-center justify-between gap-3">
        ...
        <div className="flex min-w-0 items-center gap-3">
          ...
          {backHref && (
            <Link
              href={backHref}
              className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg border border-slate-700 bg-slate-900 text-slate-300 transition hover:border-slate-500 hover:text-white"
              aria-label="Go back"
            >
