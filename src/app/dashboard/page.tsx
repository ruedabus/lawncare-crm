        ...
        <section className="grid gap-6 lg:grid-cols-3">
          ...
          <PanelCard title="Weather">
            {currentCode !== null && currentTemp !== null ? (
              <div className="space-y-4">
                {/* Current conditions */}
                <div className="flex items-center gap-4 rounded-xl bg-gradient-to-br from-sky-50 to-blue-100 px-4 py-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-400">{weatherCity}, {weatherState}</p>
                  </div>
                </div>
                ...
                {forecast.length > 0 && (
                  <div className="grid grid-cols-5 gap-1">
                    {forecast.map((day, i) => (
                      <div
                        key={day.date}
                        className="flex flex-col items-center gap-1 rounded-xl bg-slate-50 py-2 px-1"
                      >
